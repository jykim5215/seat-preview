...
- 측면 투사면과 정면 스크린 사이에 이음 틈이 보이면 안 된다.
...
2. **스크린 좌우의 커튼/흡음벽, 천장, 통로 유도등** — 어두운 무채색 재질. 유도등은 바닥 통로를 따라 매우 약한 점광.
   추가로 **비상구**: 스크린 좌우 하단의 출입구(문 실루엣)와 그 위 녹색 유도등(EXIT 사인, 은은한 자발광 #3fae4c 수준). 상영 중 극장에서 실제로 항상 보이는 요소다. 과하게 밝히지 말 것.
...
5. **스크린 게인/핫스팟** — 시선 방향과 스크린 법선이 가까운 영역이 미세하게 더 밝은 효과. 셰이더 또는 머티리얼 트릭으로 아주 약하게.
